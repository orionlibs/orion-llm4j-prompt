...
public class OrionConfiguration extends Properties
{
     ...
     */
    public static final String FEATURE_CONFIGURATION_FILE = "/io/github/orionlibs/orion-llm4j-prompt/configuration/orion-feature-configuration.prop";
    ...
    public static OrionConfiguration loadFeatureConfiguration(Properties customConfig) throws IOException
    {
        ...
        {
            throw new IOException("Could not setup feature configuration for Orion LLM4J Prompt: ", e);
        }
    }
